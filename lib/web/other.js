...
var OtherFn = function () {
    function OtherFn() {
        _classCallCheck(this, OtherFn);
    }

    _createClass(OtherFn, [{
        key: 'deepClone',
        ...
        key: 'circleImpact',
        value: function circleImpact(circle1, circle2) {
        ...
        key: 'rectImpact',
        value: function rectImpact(rect1, rect2) {
        ...
        key: 'photoCompress',
        value: function photoCompress(file, obj, cb) {
            /*
                obj = {
                    width: 图片宽,
                    height: 图片高,
